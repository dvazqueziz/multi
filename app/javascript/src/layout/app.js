...
var App = function () {
    ...
    var initCheck = function () {
        // Toggle Handler
        Util.on(document.body, '[data-kt-check="true"]', 'change', function (e) {
            var check = this;
            ...
            new SmoothScroll('a[data-kt-scroll-toggle][href*="#"]', {
                ...
                offset: function (anchor, toggle) {
                    ...
                    if (anchor.hasAttribute('data-kt-scroll-offset')) {
                        var val = Util.getResponsiveValue(anchor.getAttribute('data-kt-scroll-offset'));
    ...
    return {
        ...
        windowOnLoad: function () {
            window.addEventListener("turbo:load", App.initPageLoader)
        }
    };
}();
