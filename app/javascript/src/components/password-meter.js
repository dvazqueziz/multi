...
var PasswordMeter = function (element, options) {
    ...
    var _init = function () {
        ...
        // Set initialized
        the.element.setAttribute('data-controller', 'components--password-meter');
...
// Create instances
PasswordMeter.createInstances = function (selector = '[data-controller="components--password-meter"]') {
    // Get instances
    ...
    if (elements && elements.length > 0) {
        for (var i = 0, len = elements.length; i < len; i++) {
            ...
            let instance = PasswordMeter.getInstance(elements[i])
            if (!instance) {
